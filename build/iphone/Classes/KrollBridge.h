...
@interface NATOAcronymsObject : KrollCoverageObject {
#else
@interface NATOAcronymsObject : KrollObject {
#endif
@private
...
extern NSString * NATOAcronyms$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	NATOAcronymsObject *_natoacronyms;
    KrollObject* console;
	BOOL shutdown;
