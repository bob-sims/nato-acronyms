 ...
 * Copyright (c) 2009-2011 by NATOAcronyms, Inc. All Rights Reserved.
...
//@interface NATOAcronymsObject : NSObject
//@end

@interface NATOAcronymsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NATOAcronymsObject class]])
		{
			for (NSString *key in [[(NATOAcronymsObject*)o modules] allKeys])
			{
