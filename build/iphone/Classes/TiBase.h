...
// in simulator we redefine to format for NATOAcronyms Developer console
...
{\
	NSString * exceptionName = [@"org.natoacronyms." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.natoacronyms";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UINATOAcronymsNativeItemNone = -1, 
	UINATOAcronymsNativeItemSpinner = -2,
	UINATOAcronymsNativeItemProgressBar = -3,
	
	UINATOAcronymsNativeItemSlider = -4,
	UINATOAcronymsNativeItemSwitch = -5,
	UINATOAcronymsNativeItemMultiButton = -6,
	UINATOAcronymsNativeItemSegmented = -7,
	
	UINATOAcronymsNativeItemTextView = -8,
	UINATOAcronymsNativeItemTextField = -9,
	UINATOAcronymsNativeItemSearchBar = -10,
	
	UINATOAcronymsNativeItemPicker = -11,
	UINATOAcronymsNativeItemDatePicker = -12,
	
	UINATOAcronymsNativeItemInfoLight = -13,
	UINATOAcronymsNativeItemInfoDark = -14,
	
	UINATOAcronymsNativeItemDisclosure = -15,
	
	UINATOAcronymsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NATOAcronyms instances of
