...
//Rare exceptions to indicate a bug in the _natoacronyms code (Eg, function that a subclass should have implemented)
...
/**
 The base class for NATOAcronyms proxies.
 */
