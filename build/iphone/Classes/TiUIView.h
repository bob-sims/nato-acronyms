...
/**
 Base class for all NATOAcronyms views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the NATOAcronyms view hierarchy (such as wrapped iOS UIViews) was touched.
